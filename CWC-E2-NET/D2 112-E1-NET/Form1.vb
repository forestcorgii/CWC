    ...
    Public Function state() As Boolean
        ...
        If Not Form1.txtValue.Text = "" Then
            If Form1.txtValue.Text.Contains("  ") = True Then
                MsgBox("Text contains double spaces")
                Return False
            Else
                Return True
            End If
...
Public Class Form1
    ...
    Public Function getCode(ByVal code As String)
       ...
       "  Data Source=" & Application.StartupPath & "\Codings-E2.mdb" & ";User Id=admin;Password=;")
...
openagain:  OpenFileDialog1.FileName = "00000001"
        ...
        If ask = Windows.Forms.DialogResult.OK Then
            If Not parent = "Entry2" Then
                valBox2("Please Select Database From Entry2 Folder")
                GoTo openAgain
            Else
    ...
    Private Sub txtValue_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtValue.KeyDown
        ...
        ElseIf txtValue.MaxLength = 1 Then
            Select Case lblFieldName.Text
                ...
                Case "advertisement", "1stBaby", "HeartSmart", "qasFlag", "adt", "advetori", "axa", "BOBA", "consider", "content", "coupon", "dhaO3", "editorial", "factsUp", "financialFuture", "hamange", "hamangeolC", "influence", "makeAPurchase", "milk", "notice", "offer", "receiveSample", "receiveSamples", "review", "stonyfie"
                    valid = True
                Case "healthCare"
                    valid = True
                Case "issue"
        ...
        End If
          ...
          Select Case lblFieldName.Text
            ...
            Case "phone"
                e.Handled = alphaOrNum(e, 0, , "-() ")
            Case "gender1", "gender2", "gender3"
                e.Handled = alphaOrNum(e, 2, "BGUbgu")
